...
_INTENTS: list[VoiceIntent] = [
    ...
    _vi("invoice.list", "billing", "List invoices and their payment status", _R,
        phrases=("zobraz faktury", "moje faktury", "seznam faktur", "ukaž faktury",
                 "nezaplacené faktury", "jaké mám faktury", "kdo mi dluží",
                 "list invoices", "show invoices", "my invoices", "unpaid invoices",
                 "who owes me"),
        examples=("ukaž nezaplacené faktury", "show unpaid invoices")),

    _vi("quote.create", "billing", "Create a price quote", _W,
    ...
    _vi("quote.list", "billing", "List price quotes", _R,
        phrases=("zobraz nabídky", "moje nabídky", "seznam nabídek", "ukaž nabídky",
                 "jaké mám nabídky",
                 "list quotes", "show quotes", "my quotes", "show estimates"),
        examples=("ukaž nabídky", "show quotes")),

    _vi("lead.create", "crm", "Record a new sales lead / inquiry", _W,
        phrases=("nová poptávka", "zapiš poptávku", "přidej poptávku", "nový zájemce",
                 "zapiš zájemce", "přidej zájemce", "vytvoř poptávku", "eviduj poptávku",
                 "new lead", "add lead", "create lead", "log an inquiry",
                 "new inquiry", "record a lead"),
        required=("name",), optional=("phone", "note"),
        examples=("nová poptávka Karel Dvořák", "new lead John Doe")),

    _vi("lead.list", "crm", "List open leads / inquiries", _R,
        phrases=("zobraz poptávky", "moje poptávky", "seznam poptávek", "ukaž poptávky",
                 "jaké mám poptávky", "otevřené poptávky",
                 "list leads", "show leads", "my leads", "open leads"),
        examples=("ukaž poptávky", "show leads")),

    _vi("client.note", "crm", "Add a note to a client", _W,
        phrases=("přidej poznámku", "poznámka ke klientovi", "zapiš poznámku",
                 "poznamenej si", "přidej poznámku ke klientovi",
                 "add note", "note for client", "add a note to", "make a note"),
        required=("person", "note"),
        examples=("přidej poznámku ke klientovi Novák", "add note to client Smith")),

    _vi("task.assign", "crm", "Assign a task to a person", _W,
        phrases=("přiřaď úkol", "předej úkol", "deleguj úkol", "přiřadit úkol",
                 "assign task", "assign the task", "delegate task", "give the task to"),
        required=("person",),
        examples=("přiřaď úkol sekání Petrovi", "assign the task to Peter")),

    _vi("invoice.send", "billing", "Send an invoice to the client", _W,
        implemented=False,
        phrases=("pošli fakturu", "odešli fakturu", "zašli fakturu",
                 "pošli fakturu klientovi",
                 "send invoice", "send the invoice", "email the invoice"),
        optional=("client",),
        fallback="Odeslání faktury z hlasu zatím není dostupné, brzy ho doplníme.",
        examples=("pošli fakturu Novákovi", "send the invoice to Smith")),
