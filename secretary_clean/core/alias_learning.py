...
SUPPORTED_INTENTS = {
    ...
    "client.create", "task.create", "task.list", "task.complete", "job.create", "job.list", "job.change_status", "comm.log", "comm.list", "whatsapp.send", "whatsapp.read", "weather.get", "client.set_address",
}
