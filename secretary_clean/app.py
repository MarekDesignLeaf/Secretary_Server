...
async def lifespan(app: FastAPI):
    # NOTE: the background auto-sync loop was REMOVED. Its two-way reconcile
    # flooded the calendar with duplicate imports and hit Google rate limits.
    # Calendar sync is now manual-only (POST /calendar/google/sync), one-way,
    # and idempotent (see core/google_sync.reconcile).
