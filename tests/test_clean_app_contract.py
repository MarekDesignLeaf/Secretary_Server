...
def test_clean_first_install_creates_ready_company_admin_languages_and_industry(monkeypatch):
    ...
    first_install = client.post(
        ...
        json={
            ...
            "default_customer_language_code": "pl-PL",
            "workspace_mode": "team",
            "selected_industries": ["trades_and_field_services"],
            "selected_subtypes": ["trades_and_field_services.landscaping"],
            "selected_activities": ["trades_and_field_services.landscaping.garden_maintenance"],
            "primary_industry": "trades_and_field_services",
            "primary_subtype": "trades_and_field_services.landscaping",
